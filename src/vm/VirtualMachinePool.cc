...
void VirtualMachinePool::stateinfo (int oid,int* state)
{

       PoolSQL::bkstate(oid);
     
       *state = PoolSQL::bkSTATE;  
}
...
void VirtualMachinePool::diskstateinfo (int oid,int* state)
{
       PoolSQL::dkstate(oid);
     
    *state = PoolSQL::dkSTATE;  
}
...
void VirtualMachinePool::updatebkstate (int oid,Backup::BkState state )
{
        
       
       PoolSQL::updatebkstate(oid,state);
...
int  VirtualMachinePool::checkbid (int bid )
{
        
     
       PoolSQL::getbid(bid);
       
       return PoolSQL::checkgetbid;
...
void VirtualMachinePool::bkdir (int oid,string* bkrecover)
{

       PoolSQL::bkdir(oid);
     
    *bkrecover = PoolSQL::bkDIR;  
}
