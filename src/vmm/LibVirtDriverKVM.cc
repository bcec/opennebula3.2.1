        ...
        const string&           file_name) const
{
    ...
    int source_dm_num = 0; //added by shenxy
    int order = 0;
    ...
    string source_dm  = "";      //added by shenxy
    ...
    for (int i=0; i < num ;i++)
    {
        ...
        source_dm = disk->vector_value("SOURCE_DM");   //added by shenxy
        ...
        if ( type == "BLOCK" )            
        {
                ...
                else                 //added  by shenxy
                {
                         file << "\t\t<disk type='block' device='disk'>" << endl
                         << "\t\t\t<source dev='" <<source_dm<< "'/>" << endl;
                         source_dm_num+=1;
                }      
        }
        else if ( type == "CDROM" )
    ...
    order = num-source_dm_num;  //added by shenxy
