...
void LifeCycleManager::trigger(Actions action, int _vid)
{
    ...
    case OFF_SUCCESS:                       //added by shenxy
        aname = "OFF_SUCCESS";
        break;  
    ...
    case XMLIST_SUCCESS:          //added by shenxy
        aname = "XMLIST_SUCCESS";
        break;

    case XMLIST_FAILURE:                 //added by shenxy
        aname = "XMLIST_FAILURE";
        break;    
    ...
    case BACKUP:                            //added by shenxy
        aname = "BACKUP";
        break;    

    case RECOVER:                          //added by shenxy
        aname = "RECOVER";
        break;        

    case BACKUPDISK:                     //added by shenxy
        aname = "BACKUPDISK";
        break;                 
...
void LifeCycleManager::do_action(const string &action, void * arg)
{
    ...
    else if (action == "OFF_SUCCESS")                     //added by shenxy
    {
        off_success_action(vid);
    }
    else if (action == "CANCEL_FAILURE")
    {
        cancel_failure_action(vid);
    }
    else if (action == "XMLIST_SUCCESS")              //added by shenxy
    {        
        xmlist_success_action(vid);
    }
    else if (action == "XMLIST_FAILURE")                        //added by shenxy
    {
        xmlist_failure_action(vid);
    }
    else if (action == "PROLOG_RECOVER_DECOMPRESS")     //added by shenxy
    {
        prolog_recover_decompress_action(vid);
    }
    ...
    else if (action == "OFF")                  //added by shenxy
    {
        off_action(vid);
    }
    else if (action == "ON")                       //added by shenxy
    {
        on_action(vid);
    }
    ...
    else if (action == "RECOVER")              //added by shenxy
    {
        recover_action(vid);
    }
