    ...
    if (action == "TRANSFER")
    {
        ...
        if (result == "SUCCESS")
        {
            switch (vm->get_lcm_state())
            {
                ...
                case VirtualMachine::PROLOG_BACKUP:                //added by shenxy
                case VirtualMachine::PROLOG_BACKUPDISK:         //added by shenxy  
                case VirtualMachine::PROLOG_RESUME:
                case VirtualMachine::DELETE_RECOVER_FAIL:       //added by shenxy   
                case VirtualMachine::RECOVER_DECOMPRESS_FAIL:
                case VirtualMachine::DELETE_BACKUP_FAIL:       //added by shenxy   
                case VirtualMachine::PROLOG_RECOVER_DECOMPRESS:
                   lcm_action = LifeCycleManager::PROLOG_SUCCESS;
                    break;

                case VirtualMachine::PROLOG_RECOVER:              //added by shenxy 
                    lcm_action = LifeCycleManager::PROLOG_RECOVER_DECOMPRESS;
                    break;

                //added by shenxy
                case VirtualMachine::DELETEBAK: 
                case VirtualMachine::DELETE_BACKUP_COMPRESS: 
                    lcm_action = LifeCycleManager::DEPLOY_SUCCESS;
                    break;   

                //added by shenxy
                case VirtualMachine::OFF: 
                    vm->log("xm list",Log::ERROR,os);
                    lcm_action = LifeCycleManager::XMLIST_SUCCESS;
                    break;   
        ...
        else
        {
            ...
            switch (vm->get_lcm_state())
            {
                case VirtualMachine::PROLOG:
                case VirtualMachine::PROLOG_MIGRATE:
                case VirtualMachine::PROLOG_BACKUP:    
                case VirtualMachine::PROLOG_BACKUPDISK:      
                case VirtualMachine::PROLOG_RESUME:
                case VirtualMachine::DELETE_RECOVER_FAIL:    
                case VirtualMachine::RECOVER_DECOMPRESS_FAIL:   
                case VirtualMachine::DELETE_BACKUP_FAIL:        
                case VirtualMachine::PROLOG_RECOVER:    
                case VirtualMachine::PROLOG_RECOVER_DECOMPRESS:   
                    lcm_action = LifeCycleManager::PROLOG_FAILURE;
                    break;

                case VirtualMachine::OFF:
                    lcm_action = LifeCycleManager::XMLIST_FAILURE;
                    break;     

                case VirtualMachine::DELETEBAK:
                    vm->log("delete backup",Log::ERROR,os);
                    lcm_action = LifeCycleManager::DEPLOY_SUCCESS;
                    break;    

                case VirtualMachine::DELETE_BACKUP_COMPRESS:
                    vm->log("delete backup_cps",Log::ERROR,os);
                    lcm_action = LifeCycleManager::DEPLOY_SUCCESS;
                    break;    
