...
module OpenNebula
    class VirtualMachine < PoolElement
        ...
        LCM_STATE=%w{LCM_INIT PROLOG BOOT RUNNING MIGRATE SAVE_STOP SAVE_SUSPEND
            ...
            SHUTDOWN CANCEL FAILURE CLEANUP UNKNOWN OFF OFF_BACKUP 
            PROLOG_BACKUP OFF_RECOVER PROLOG_RECOVER DELETEBAK 
            DELETE_RECOVER_FAIL DELETE_BACKUP_FAIL OFF_BACKUPDISK 
            PROLOG_BACKUPDISK ON DELETE_BACKUP_COMPRESS 
            PROLOG_RECOVER_DECOMPRESS RECOVER_DECOMPRESS_FAIL}
        ...
        SHORT_LCM_STATES={
            ...
            "OFF"              =>  "off",
            "OFF_BACKUP"  => "backup",
            "PROLOG_BACKUP"  => "backup",
            "OFF_RECOVER"    => "recover",
            "PROLOG_RECOVER" => "recover",
            "DELETEBAK"     =>  "delbak",
            "DELETE_RECOVER_FAIL"  =>  "derf",
            "DELETE_BACKUP_FAIL" => "debf",
            "OFF_BACKUPDISK"    => "disk",
            "PROLOG_BACKUPDISK"  => "disk",
            "ON"                               => "disk",
            "DELETE_BACKUP_COMPRESS" =>"debc",
            "PROLOG_RECOVER_DECOMPRESS" =>"decps",
            "RECOVER_DECOMPRESS_FAIL"  =>"decps_fail"
        }
