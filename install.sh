...
SHARED_TM_COMMANDS_LIB_FILES="src/tm_mad/shared/tm_clone.sh \
                           ...
                           src/tm_mad/shared/tm_bk.sh \
                           src/tm_mad/shared/tm_mkvmimage.sh \
                           src/tm_mad/shared/tm_bk_compress.sh \
                           src/tm_mad/shared/tm_decompress.sh \
                           src/tm_mad/shared/xm_list.sh \
                           src/tm_mad/shared/tm_rename.sh \
...
SSH_TM_COMMANDS_LIB_FILES="src/tm_mad/ssh/tm_clone.sh \
                           ...
                           src/tm_mad/ssh/tm_bk.sh \
                           src/tm_mad/ssh/tm_mkvmimage.sh \
                           src/tm_mad/ssh/tm_bk_compress.sh \
