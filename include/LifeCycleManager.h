...
private:
    ...
    void off_success_action(int vid);    //added by shenxy

    void xmlist_success_action(int vid);    //added by shenxy

    void xmlist_failure_action(int vid);      //added by shenxy

    void prolog_recover_decompress_action(int vid);  //added by shenxy
    ...
    void off_action(int vid);   //added by shenxy

    void on_action(int vid);   //added by shenxy

    void checkpoint_action(int vid);

    void migrate_action(int vid);

    void backup_action(int vid);  //added by shenxy

    void recover_action(int vid);   //added by shenxy

    void backupdisk_action(int vid);   //added by shenxy
